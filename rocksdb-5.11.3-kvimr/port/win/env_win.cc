...
WinEnvIO::WinEnvIO(Env* hosted_env)
  ...
  if (module != NULL) {
    FARPROC proc = GetProcAddress(module, "GetSystemTimePreciseAsFileTime");
    std::memcpy(&GetSystemTimePreciseAsFileTime_, &proc,
                sizeof(GetSystemTimePreciseAsFileTime_));
  }
}
